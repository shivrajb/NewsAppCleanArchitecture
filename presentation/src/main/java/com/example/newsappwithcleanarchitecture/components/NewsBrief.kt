...
import com.example.newsappwithcleanarchitecture.ui.theme.Calisto
import com.example.newsappwithcleanarchitecture.ui.theme.RockWell
import com.example.newsappwithcleanarchitecture.utils.extractDate
...
fun NewsBrief(
    ...
    ConstraintLayout(
        Modifier.fillMaxWidth().clickable { onClick(data) }
    ) {
