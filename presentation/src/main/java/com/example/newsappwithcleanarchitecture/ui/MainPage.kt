...
import com.example.newsappwithcleanarchitecture.components.Headline
import com.example.newsappwithcleanarchitecture.components.NewsFilter
import com.example.newsappwithcleanarchitecture.components.SearchedNewsUi
...
fun MainPage(
    ...
    Box(
        ...
        Column(
            ...
            vm.searchResult?.let { SearchedNewsUi(data = it, onSelect = onSelect) }
